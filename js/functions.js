...
function moverCameraParaSistemaSolar() {
    ...
    setTimeout(() => {
        ...
        scene.remove(MoonBg); // Lua
        scene.remove(sunMoonSphere); // Lua
        scene.remove(glowSpriteMoon); // Lua
        scene.remove(earthMoonSphere); // Lua
        scene.remove(earthCloudMoonSphere); // Lua
        ...
        // Liga visibilidade do objetos
        solarSystemSwitch('on');
...
function moverCameraParaExplorarTerra(cena) {
    ...
    setTimeout(() => {
        ...
        // Desliga visibilidade dos objetos
        solarSystemSwitch('off');
...
function moverCameraParaExplorarLua(cena) {
    ...
    setTimeout(() => {
        ...
        scene.add(glowSpriteMoon);
        scene.add(earthMoonSphere);
        scene.add(earthCloudMoonSphere);
...
// Função para chamar a div de carregamento
...
// Remove e adiciona elementos do sistema solar ao sair ou entrar na cena (implementado para evitar muitos objetos sejam carregadas simultaneamente)
function solarSystemSwitch(estado){
    if(estado == 'on'){
        scene.add(starField); // Campo estelar
        scene.add(bgSphere); // Background
        scene.add(sunSphere); // Sol
        scene.add(glowSprite); // Glowsprite do Sol
        scene.add(mercurySphere, mercuryOrbit, mercuryMarker); // Mercúrio
        scene.add(venusSphere, venusOrbit, venusMarker); // Vênus
        scene.add(venusatmosphereSphere); // Atmosfera de Vênus
        scene.add(earthSphere, earthOrbit, earthMarker); // Terra
        scene.add(earthCloudSphere); // Nuvens da Terra
        scene.add(moonSphere, moonOrbit, moonMarker); // Lua
        scene.add(marsSphere, marsOrbit, marsMarker); // Marte
        scene.add(jupiterSphere, jupiterOrbit, jupiterMarker); // Júpiter
        scene.add(saturnSphere, saturnOrbit, saturnMarker); // Saturno 
        scene.add(saturnRing); // Anel de Saturno
        scene.add(uranusSphere, uranusOrbit, uranusMarker); // Urano
        scene.add(neptuneSphere, neptuneOrbit, neptuneMarker); // Netuno
        scene.add(ceresSphere, ceresOrbit, ceresMarker); // Ceres
        scene.add(makemakeSphere, makemakeOrbit, makemakeMarker); // Makemake
        scene.add(erisSphere, erisOrbit, erisMarker); // Éris
        scene.add(haumeaSphere, haumeaOrbit, haumeaMarker); // Haumea
        scene.add(plutoSphere, plutoOrbit, plutoMarker); // Plutão
        scene.add(charonSphere, charonOrbit, charonMarker); // Caronte
    }else if(estado == 'off'){
        scene.remove(starField);
        scene.remove(bgSphere);
        scene.remove(sunSphere); 
        scene.remove(glowSprite);
        scene.remove(mercurySphere, mercuryOrbit, mercuryMarker);
        scene.remove(venusSphere, venusOrbit, venusMarker);
        scene.remove(venusatmosphereSphere);
        scene.remove(earthSphere, earthOrbit, earthMarker);
        scene.remove(earthCloudSphere);
        scene.remove(moonSphere, moonOrbit, moonMarker);
        scene.remove(marsSphere, marsOrbit, marsMarker);
        scene.remove(jupiterSphere, jupiterOrbit, jupiterMarker);
        scene.remove(saturnSphere, saturnOrbit, saturnMarker);
        scene.remove(saturnRing);
        scene.remove(uranusSphere, uranusOrbit, uranusMarker);
        scene.remove(neptuneSphere, neptuneOrbit, neptuneMarker);
        scene.remove(ceresSphere, ceresOrbit, ceresMarker);
        scene.remove(makemakeSphere, makemakeOrbit, makemakeMarker);
        scene.remove(erisSphere, erisOrbit, erisMarker);
        scene.remove(haumeaSphere, haumeaOrbit, haumeaMarker);
        scene.remove(plutoSphere, plutoOrbit, plutoMarker);
        scene.remove(charonSphere, charonOrbit, charonMarker);
    }
}